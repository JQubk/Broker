        ...
        <div class="broker-dashboard__row d-flex flex-column flex-xl-row gap-3">
            <div class="broker-dashboard__summary flex-grow-1">
                <div class="row row-cols-1 row-cols-md-4">
                    <div class="col">
                        <div class="p-3 border rounded d-flex h-100 flex-column justify-content-center align-items-center ">
                    ...
                    <div class="col">
                        <div class="p-3 border rounded d-flex h-100 flex-column justify-content-center align-items-center ">
                            ...
                            <div class="h5 mb-0" id="broker-sum-booking text-center">0 AED</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="p-3 border rounded d-flex h-100 flex-column justify-content-center align-items-center ">
